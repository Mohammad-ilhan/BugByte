      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-muted-foreground font-body text-base sm:text-lg lg:text-xl max-w-2xl mx-auto mb-10 leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="flex items-center gap-3 sm:gap-4 justify-center flex-wrap mb-16"
          >
            <MagneticButton
              href="#contact"
          ...
          <motion.div
            ...
            className="grid grid-cols-3 max-w-3xl mx-auto border-t border-border pt-8"
          >
            {[
