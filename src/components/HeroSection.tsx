      ...
      <motion.div style={{ y: contentY }} className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-8 items-center">
          ...
          <motion.div
            ...
            className="relative h-[520px] sm:h-[600px] lg:h-[640px] hidden md:block flex items-center justify-center"
          >
            <div className="text-foreground" style={{ width: "200px", height: "200px" }}>
              <BugByteLogo />
            </div>
          </motion.div>
        </div>
